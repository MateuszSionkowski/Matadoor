...
function generateJS()
{
var matadoorInput = { startURL: startURL, numbAfterStart: numbAfterStart, frameWidth: frameWidth, frameHeight: frameHeight, iOpacity: iOpacity, actionList: actionList, clickableTagNames: ["A","INPUT","BUTTON"], clickableClassName: "MATADOOR_CLICKABLE" }
...
function start() {
  ...
  iOpacity=document.getElementById("iOpacity").value/100;
